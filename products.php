...
<html>
  <head>
    <title>Gawds eMarket Products</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link href="css/style.css" rel="stylesheet">
  </head>
  <body>
	<div id="topnav">
		<a class="navbutton" href="home.html">How to Buy/Sell</a>
		<a class="navbutton" href="register.php">Register/Login</a>
		<a class="navbutton" href="home.html#aboutus">About Us</a>
	</div>
		<div id="adplace">
			<span>Currently, there are no products to sell. If you want to sell, please register and add products.</span>
		</div>
		<div id="item">
			...
			<div class="description">
				...
				<div id="cost"><img class="loading" src="images/loading.gif"/></div><span class="bid" style="display:none">Bid Now</span>
				<br><hr/><br>
				<div id="contact">
		...
		<div id="bottom"><a href="http://gawds.in">gawds.in</a> &copy; 2014 - 2015 GAWDS - Graphics and Web Development Squad, NIT Kurukshetra </div>
		...
		<script>
			$('body').on('click','.ad',function(){
				...
				$.get( "contact_reply.php?productid="+product_id+"&query=blockno", function( data ) {
					$('#item #contact #address').append(', Block <span style="text-transform:uppercase;">'+data+'</span>');
				});
			...
			function loadAds(i,productid){
				...
				console.log($( ".ad:nth-child("+i+") .pid" ).text());
			}
		</script>
  </body>
</html>