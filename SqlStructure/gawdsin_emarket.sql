...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2017 at 09:17 PM
...
(55, 'cycle', '', '10000', 'ghwgci', '0', 0, '1130607', 1, '1130607_1', 0, 0, ''),
(56, 'DFSDAF', '', '234', 'SADFSDAFDSF', '0', 0, '1120168', 1, '1120168_1', 0, 0, '');
...
(3, 'sarin', 2147483647, 'sarinshubham@gmail.com', 1120168, '9', 'd', '369', 'c', 0, 1),
...
(91, 'KUNAL SHARMA', 9997209034, 'kunalprince036@gmail.com', 1130548, '2', 'D', '223', 'supriya', 0, 0),
(92, 'pratik', 0, 'prasodani@gmail.com', 1130607, '7', 'b', '330', 'rand', 0, 1);
...
--
ALTER TABLE `uploads`
  MODIFY `count` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT for table `userid`
--
ALTER TABLE `userid`
  MODIFY `serialno` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
--
